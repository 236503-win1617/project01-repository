...
public class AbstractEmptyScreen extends JFrame {
    protected final static Integer X_SCREEN_START_FROM = 50;
    protected final static Integer Y_SCREEN_START_FROM = 50;
    ...
    protected void setCustomInsets(int top, int left, int bottom, int right) {
        constraints.insets = new Insets(top, left, bottom, right);
    }

    protected void setSquareInsets(int squareInsets) {
        constraints.insets = new Insets(squareInsets, squareInsets, squareInsets, squareInsets);
    }
