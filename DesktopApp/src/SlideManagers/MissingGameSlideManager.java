 ...
 */
public class MissingGameSlideManager extends AbstractSlideManager{
    public MissingGameSlideManager(JPanel currentSlide, JPanel commandsPanel){
    ...
    public void loadSlide(AbstractSlide slide, JButton button) throws IOException{
        ...
        loadSameImageToPanelAndButton(ImageIO.read(FileResources.getMissingGameImage()), Rotation.NO_ROTATION.getRotationInRadians());
    }
