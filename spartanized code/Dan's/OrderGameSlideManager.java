...
public class OrderGameSlideManager extends AbstractSlideManager{
    ...
    public void loadSlide(AbstractSlide s) throws IOException{
        if (first) {
            ...
            ((OrderGameSlide) s).setMaxNum(maxNum);
            first = false;
        }
        loadPictureFromFile(new FileInputStream(".\\resources\\placeholder.png"), Rotation.NO_ROTATION);
    }
    ...
    public void addNewSoundElement(SoundElement e){}
}
